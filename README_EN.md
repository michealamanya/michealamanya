# Amanya Micheal - AI Engineer & Innovator
...
- 📚 Blog metadata for automation: [BLOG_POSTS.json](./BLOG_POSTS.json)

See the main [README.md](./README.md) for the full interactive profile experience.
